...
public:
     ...
     */
    [[nodiscard]] constexpr bool operator!=(const ::Vector2& other) const noexcept { return !(*this == other); }

    constexpr std::string ToString() const noexcept { return TextFormat("Vector2(%f, %f)", x, y); }

    constexpr operator std::string() const noexcept { return ToString(); }
     ...
     */
    constexpr Vector2 Normalize() const noexcept { return Vector2Normalize(*this); }

    /**
     * Transforms a Vector2 by a given Matrix
     */
    constexpr Vector2 Transform(::Matrix mat) const noexcept { return ::Vector2Transform(*this, mat); }
     ...
     */
    [[nodiscard]] static Vector2 Zero() { return Vector2Zero(); }

    /**
     * Vector with components value 1.0f
     */
    [[nodiscard]] static Vector2 One() { return Vector2One(); }
#endif
