    ...
    class Color : public ::Color {
       public:
        ...
        constexpr Color(
            ...
            unsigned char green,
            unsigned char blue,
            unsigned char alpha = 255) noexcept : ::Color{red, green, blue, alpha} {};
         ...
         */
        Color(unsigned int hexValue) noexcept {
         ...
         */
        inline ::Color Tint(::Color tint) noexcept {
         ...
         */
        inline ::Color Brightness(float factor) noexcept {
         ...
         */
        inline ::Color Contrast(float contrast) noexcept {
         ...
         * Returns color with alpha applied, alpha goes from 0.0f to 1.0f
         */
        inline ::Color Alpha(float alpha) const noexcept {
         ...
         */
        inline ::Color AlphaBlend(::Color dst, ::Color tint) const noexcept {
